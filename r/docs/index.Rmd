--- 
title: "EcoSHEDS Northeast Stream Temperature Model"
author: "Developed and maintained by [Jeff Walker](https://walkerenvres.com) and [Ben Letcher](https://www.usgs.gov/staff-profiles/benjamin-h-letcher) as part of the [USGS EcoSHEDS](https://usgs.gov/apps/ecosheds/) project.<br>Initial model developed by [Dan Hocking](https://hockinglab.weebly.com/)."
...
link-citations: yes
github-repo: ecosheds/northeast-temp-model
description: "Documentation for the EcoSHEDS Northeast Stream Temperature Model."
editor_options: 
...
The source code for the model itself and this documentation is available in the Github repository [ecosheds/northeast-temp-model](https://github.com/ecosheds/northeast-temp-model). Each version of the model will be included under the list of  [Releases](https://github.com/ecosheds/northeast-temp-model/releases).
