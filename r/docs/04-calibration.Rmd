...
Figures \@ref(fig:plot-series-calib-best) to \@ref(fig:plot-series-calib-worst-trend) show example deployments from the calibration dataset with the highest and lowest RMSE.
...
Figures \@ref(fig:plot-series-valid-best) to \@ref(fig:plot-series-valid-worst-trend) show example deployments from the validation dataset with the highest and lowest RMSE.
