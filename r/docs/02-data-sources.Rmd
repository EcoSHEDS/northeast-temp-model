...
The stream temperature model uses the [National Hydrography Dataset High Resolution Delineation Version 2 (NHDHRDV2)](https://ecosheds.github.io/necd/) catchment delineation.

Shapefiles of the catchments can be downloaded from: https://ecosheds.github.io/necd/catchment-delineation.html
...
Geospatial characteristics of each catchment were generated using the code in [basinCharacteristics](https://github.com/Conte-Ecology/shedsGisData/tree/master/basinCharacteristics). More information can be found on the [SHEDS GIS Data](https://ecosheds.github.io/necd/) page.
